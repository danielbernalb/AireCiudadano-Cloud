...
for application in prometheus pushgatewaypython grafana mosquitto letsencrypt victoria vmalert
do
...
cd $HOME
git clone --branch cambios43_2mayo2026_vm https://github.com/danielbernalb/aireciudadano-cloud.git
